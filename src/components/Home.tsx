export default function Home() {
  return (
    <div id="home" className="grid h-screen grid-rows-6">
      <nav className="bg-black-custom text-white-custom z-20 row-span-2 flex flex-col justify-start space-y-5 bg-opacity-70 p-5 text-right text-3xl lg:col-span-2 lg:row-span-1 lg:flex-row lg:items-center lg:justify-end lg:space-x-10 lg:space-y-0 lg:px-20 lg:text-left lg:text-4xl">
      ...
      <div className="row-span-3  lg:grid lg:grid-cols-5">
        <div className="text-white-custom relative z-20 mt-20 p-5 pt-20 text-5xl font-bold uppercase lg:col-span-3 lg:p-20 lg:pt-40 lg:text-7xl">
          <h1>
